...
\renewcommand{\texttt}[1]{{\ttfamily\hyphenchar\font=`\-\relax
   \def\_{\textunderscore\penalty50 }\def\/{\char`\/\penalty50 }#1}}
...
The source repository for the paper, supplement, and reproducibility artifacts is available at \url{https://github.com/ioannist/six-birds-no-go}.
It has two purposes.
